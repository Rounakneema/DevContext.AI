        ...
        <div className="lp-hero-inner">
          ...
          <div className="lp-metric-chips">
            <div className="lp-chip">
              <span className="lp-chip-icon" style={{ color: "#7C5CDB" }}>📊</span>
              Code Quality Score
            </div>
            <div className="lp-chip">
              <span className="lp-chip-icon" style={{ color: "#27ae60" }}>🏗️</span>
              Architecture Map
            </div>
            <div className="lp-chip">
              <span className="lp-chip-icon" style={{ color: "#e67e22" }}>🎤</span>
              50 Interview Questions
            </div>
            <div className="lp-chip">
              <span className="lp-chip-icon" style={{ color: "#2980b9" }}>📝</span>
              Resume Bullets
            </div>
          </div>
        </div>
      ...
      <section id="capabilities" className="lp-section">
        <div className="lp-section-inner">
          ...
          <div className="lp-caps-grid">
            ...
            <div className="lp-cap">
              <div className="lp-cap-icon" style={{ background: "rgba(39,174,96,0.1)", color: "#27ae60" }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
            ...
            <div className="lp-cap">
              <div className="lp-cap-icon" style={{ background: "rgba(230,126,34,0.1)", color: "#e67e22" }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
                  <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" />
                </svg>
              </div>
            ...
            <div className="lp-cap">
              <div className="lp-cap-icon" style={{ background: "rgba(41,128,185,0.1)", color: "#2980b9" }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
            ...
            <div className="lp-cap">
              <div className="lp-cap-icon" style={{ background: "rgba(231,76,60,0.1)", color: "#e74c3c" }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
                  <circle cx="12" cy="12" r="10" />
